...
from ErzaScarlet import dispatcher, VILLLIANS
...
def unapproveall(update: Update, context: CallbackContext):
    ...
    if member.status != "creator" and user.id not in VILLLIANS:
...
def unapproveall_btn(update: Update, context: CallbackContext):
    ...
    if query.data == "unapproveall_user":
        if member.status == "creator" or query.from_user.id in VILLLIANS:
